...
import { ArchivedBookmarksPage } from './ArchivedBookmarksPage';
...
describe('ArchivedBookmarksPage', () => {
  afterEach(() => {
    jest.clearAllMocks();
  });
  ...
  it('renders heading', () => {
    ...
    renderWithClient(<ArchivedBookmarksPage />);
    expect(screen.getByRole('heading', { name: /archived bookmarks/i })).toBeInTheDocument();
  });
